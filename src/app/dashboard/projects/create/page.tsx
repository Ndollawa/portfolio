...
import { createCategory, categoryURI } from "@/utils/libs/categories";
...
const CreateProject = () => {
  ...
  const {
    ...
    isMutating,
    error: formError,
  } = useSWRMutation(projectURI, createProject);
  ...
  return (
    <div className="page">
      <Header title="Post > Create New Project" />
            ...
            <div className="row gutter-2">
              ...
              <div className="col-12 my-4">
                ...
                <div className="mt-1 d-flex gap-y-4 color-light r-2 shadow-sm ai-stretch overflow-hidden h-100">
                  <span className="d-flex w-10 ai-center jc-center r-tl-2 r-bl-2 border-1 px-3 text-xl ">
                    <IoMdPricetags fontSize={"1.5rem"} />{" "}
                  </span>
                  <div className="mt-1 shadow-sm p-1 border-2 border-secondary r-2 d-flex flex-wrap -ai-center m-0 w-100">
                    ...
                    <input
                      className="d-flex outline-none border-0 w-100  input-md r-2 py-2 px-4"
                      type="text"
              ...
              <div className="row col-12 gutter-x-4 mt-3 p-8">
